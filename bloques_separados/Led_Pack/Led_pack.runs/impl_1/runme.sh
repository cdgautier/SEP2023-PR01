...
HD_PWD='C:/STEM/SEP2023/proyectos/SEP2023-PR01/Led_pack.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexor_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiplexor_led.tcl -notrace
