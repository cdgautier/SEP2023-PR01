...
HD_PWD='C:/STEM/SEP2023/proyectos/SEP2023-PR01/Led_pack.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiplexor_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiplexor_led.tcl
