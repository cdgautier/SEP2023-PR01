...
HD_PWD='C:/Users/Camilo/Desktop/bloques_separados5/atg_ram/atg_ram/atg_ram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Atg_ram_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Atg_ram_wrapper.tcl -notrace
