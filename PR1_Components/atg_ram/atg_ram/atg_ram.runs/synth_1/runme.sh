...
HD_PWD='C:/Users/Camilo/Desktop/bloques_separados5/atg_ram/atg_ram/atg_ram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Atg_ram_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Atg_ram_wrapper.tcl
