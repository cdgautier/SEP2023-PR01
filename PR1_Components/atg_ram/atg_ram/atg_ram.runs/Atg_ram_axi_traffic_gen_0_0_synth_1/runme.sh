...
HD_PWD='C:/Users/Camilo/Desktop/bloques_separados5/atg_ram/atg_ram/atg_ram.runs/Atg_ram_axi_traffic_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Atg_ram_axi_traffic_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Atg_ram_axi_traffic_gen_0_0.tcl
