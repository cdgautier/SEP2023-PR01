...
HD_PWD='C:/STEM/SEP2023/proyectos/PR01_pwmdc/pwm_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log operator_full.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source operator_full.tcl
