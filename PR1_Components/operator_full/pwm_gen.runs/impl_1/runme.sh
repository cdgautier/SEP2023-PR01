...
HD_PWD='C:/STEM/SEP2023/proyectos/PR01_pwmdc/pwm_gen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log operator_full.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source operator_full.tcl -notrace
